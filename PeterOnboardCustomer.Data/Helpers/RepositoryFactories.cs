...
using PeterOnboardCustomer.Data.Repository;
using PeterOnboardCustomer.Data.Models;
using PeterOnboardCustomer.Data.Interface;
...
namespace PeterOnboardCustomer.Data.Helpers
{
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<TheCustomerContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<TheCustomerContext, object>>
            {
        ...
        /// </remarks>
        public RepositoryFactories(IDictionary<Type, Func<TheCustomerContext, object>> factories )
        {
        ...
        /// </remarks>
        public Func<TheCustomerContext, object> GetRepositoryFactory<T>()
        {
       
            Func<TheCustomerContext, object> factory;
        ...
        /// </remarks>
        public Func<TheCustomerContext, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        protected virtual Func<TheCustomerContext, object> DefaultEntityRepositoryFactory<T>() where T : class
        {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<TheCustomerContext, object>> _repositoryFactories;
