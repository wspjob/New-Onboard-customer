...
namespace PeterOnboardCustomer.Data.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public TheCustomerContext DbContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<TheCustomerContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<TheCustomerContext, object> factory, TheCustomerContext dbContext)
        {
